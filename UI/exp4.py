...
class App(ctk.CTk):
    def __init__(self,*args, **kwargs):
        ...
        self.pressure_Y_unit_label.grid(row=7, column=2, padx=(5,10), pady=(10, 0),sticky=tk.NW)
        self.set_K_label.grid(row=8, column=0, padx=(5,10), pady=(10, 0),sticky=tk.NW)
        self.set_K_entry.grid(row=8, column=1,columnspan = 3,padx=(5,10), pady=(10, 0),sticky=tk.NW)
        self.set_K_unit_label.grid(row=8, column=2, padx=(5,10), pady=(10, 10),sticky=tk.NW)
        self.start_button.grid(row=9, column=0, padx=(20,15),columnspan = 3,sticky=tk.NW)
        self.stop_button.grid(row=10,column=0, padx=(20,15),columnspan = 3,pady=10,sticky=tk.NW)
        self.save_button.grid(row=11,column=0, padx=(20,15),columnspan = 3,sticky=tk.NW)
        self.set_origin.grid(row=12,column=0, padx=(20,15),columnspan = 3,pady=(10,0),sticky=tk.NW)
        self.update_pwm_x.grid(row=13,column=0, padx=(20,15),columnspan = 3,pady=(10,0),sticky=tk.NW)
