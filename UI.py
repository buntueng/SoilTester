...
class App(ctk.CTk):
    def __init__(self,*args, **kwargs):
        ...
        self.cyclic_entry = ctk.CTkEntry(self.configuration_frame,width=150,height=40,font=eng_font,corner_radius=20)
        ...
        self.MIN_X_entry = ctk.CTkEntry(self.configuration_frame,width=90,height=40,font=eng_font,corner_radius=20)
        ...
        self.MAX_X_entry = ctk.CTkEntry(self.configuration_frame,width=90,height=40,font=eng_font,corner_radius=20)
    ...
    def run_mc (self):
        match(self.start_mc):
            ...
            case 6:
                if self.MAX_X_param:
                    MAX_X_write = ("D")+(self.MAX_X_param)+("\n")
            ...
            case 7:
                ...
                print("cyclic X  = " + cyclic)
                print("min X  = " + x_min)
                print("max X  = " + x_max)
                print("distans X  = " + x_distans)
                print(check_param_X[0])
                print(type(check_param_X))
